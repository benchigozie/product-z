#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/6a90d81028ab87d13d704e4c3d013ca35a1e7ebfd9ac2f9bc91e21c6fa0a2bf2/contract';
import endContract from '../../snapshots/6a90d81028ab87d13d704e4c3d013ca35a1e7ebfd9ac2f9bc91e21c6fa0a2bf2/contract.json' with { type: 'json' };
import type { Contract as Start } from '../../snapshots/9f6607e5b7a1f301b76273d90b2ce6f08abccf082045d8f27c71ce729b2c9396/contract';
import startContract from '../../snapshots/9f6607e5b7a1f301b76273d90b2ce6f08abccf082045d8f27c71ce729b2c9396/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
  ...
  override get operations() {
    return [
      ...
      this.addCheckConstraint({
        schema: 'public',
        table: 'user',
        constraint: 'user_status_check_6bfde060',
        expression: "\"status\" IN ('ACTIVE', 'SUSPENDED', 'BANNED', 'DELETED')",
      }),
      this.addUnique({
        schema: 'public',
        table: 'userProfile',
